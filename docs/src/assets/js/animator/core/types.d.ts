 ...
 */
export type StateType = 'TaskDefinition' | 'TaskResult' | 'TaskChain' | 'AskOracle' | 'OracleResponse' | 'ToolCall' | 'ToolResult' | 'AgentCall' | 'AgentResult' | 'AskHuman' | 'HumanResponse' | 'ExternalInput' | 'Waiting' | 'Custom';
/**
 * Categories for grouping state types by their nature.
 * Used for color coding and layout grouping.
 */
export type StateCategory = 'llm' | 'tool' | 'agent' | 'user' | 'terminal';
/**
 * Get the category for a state type
 */
export declare function getStateCategory(type: StateType): StateCategory;
/**
 ...
 */
export type EasingPreset = 'linear' | 'easeIn' | 'easeOut' | 'easeInOut' | 'easeInQuad' | 'easeOutQuad' | 'easeInOutQuad' | 'easeInCubic' | 'easeOutCubic' | 'easeInOutCubic' | 'easeInBack' | 'easeOutBack' | 'easeInOutBack';
/**
 ...
 */
export type AnimatorEvent = 'animationStart' | 'animationComplete' | 'animationStep' | 'stateChange' | 'branchCreated' | 'stackInteraction' | 'error';
/**
